...
namespace HotelProject.DtoLayer.Dtos.RoomDto
{
    public class RoomUpdateDto
    {
        ...
        [Required(ErrorMessage = "Lütfen oda numarası giriniz")] //roomnumber mutlaka girilmeli
        public string RoomNumber { get; set; }

        [Required(ErrorMessage = "Lütfen oda görsel bilgisini giriniz")]
        ...
        [StringLength(100,ErrorMessage ="Lütfen en fazla 100 karakter olacak şekilde veri girişi yapınız")]
